...
<?php 
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($title == "") {
            ...
            $query = "INSERT INTO  tbl_lifestyle(title, content, image ) VALUES('$title', '$content' , '$uploaded_image')";
...
?>
		<div id="content">
			<div id="content-header">
				...
				<a href="#">Life Style </a>
				<a href="#" class="current">Add Life Style </a>
				</div>
                <h1 align="center">Add Life Style </h1>
			</div>
