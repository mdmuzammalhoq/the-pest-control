<?php require('header.php'); ?>
		...
		<div class="control-area section-padding">
			...
			<div class="cotrol-content">
				<div class="container">
					<div class="row">
							<?php 
							$query = "SELECT * FROM tbl_ants order by id DESC LIMIT 1";
							$focus = $db->select($query);
							if ($focus) {
								while ($result = $focus->fetch_assoc()) {
							?>			
						<div class="col-md-6 control-text">
							<h3>Ants Control & Extermination Information</h3>
					...
					<div class="row">
						...
						<div class="col-md-6 control-img">
							<img src="img/die-ant.jpg" alt="" />
						</div>
						<div class="col-md-6 control-text">
						
							<h3>Prevention:</h3>
    <p><i class="fa fa-angle-right"></i>Eliminate standing water. Pests, such as ants, mosquitoes and termites, are attracted to moisture.</p>
    <p><i class="fa fa-angle-right"></i>Keep tree branches and other plants cut back from the house. Sometimes pests use these branches to get into your home.</p>
   ...
   <p><i class="fa fa-angle-right"></i> Make sure that firewood and building materials are not stored next to your home. Pests like to build nests in stacks of wood.</p>
