		...
		<div class="control-area section-padding">
			...
			<div class="cotrol-content">
				<div class="container">
					<div class="row">
							<?php 
							$query = "SELECT * FROM tbl_snake order by id DESC LIMIT 1";
							$focus = $db->select($query);
							if ($focus) {
								while ($result = $focus->fetch_assoc()) {
							?>			
						<div class="col-md-6 control-text">
							<h3>Snake Control & Extermination Information</h3>
					...
					<div class="row">
						...
						<div class="col-md-6 control-img">
							<img src="img/die-snake.jpg" alt="" />
						</div>
						<div class="col-md-6 control-text">
						
							<h3>Prevention:</h3>
    <p><i class="fa fa-angle-right"></i>Avoid keeping wood piles close to residences, keep rubbish heaps and composts tidy, control mouse populations by baiting or trapping.</p>
    <p><i class="fa fa-angle-right"></i>Keep all grasses low.</p>
   <p><i class="fa fa-angle-right"></i> Make sure that there are no cracks or little openings around the bottom of your house. Sometimes pests use these to get into your home.</p>
   <p><i class="fa fa-angle-right"></i>Keep gardens simple and avoid close root, ground hugging plants like agapanthus and ivy (these make great protection for snakes from natural predators as they can camouflage very well in the tight leaf and root structure, they also provide hiding places for snake's food items such as frogs and skinks).
   </p>  <p><i class="fa fa-angle-right"></i>When building rock walls, stop up any gaps with mortar, any hole could be a potential snake hide.</p>
