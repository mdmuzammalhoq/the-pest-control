<?php require('header.php') ?>
		...
		<div class="control-area section-padding">
			<div class="section-heading">
				<h1>Coackroach Control</h1>
			</div>
			<div class="cotrol-content">
				<div class="container">
					<div class="row">
							<?php 
							$query = "SELECT * FROM tbl_coackroach order by id DESC LIMIT 1";
							$focus = $db->select($query);
							if ($focus) {
								while ($result = $focus->fetch_assoc()) {
							?>			
						<div class="col-md-6 control-text">
							<h3>Cockroach Control & Extermination Information</h3>
					...
					<div class="row">
						...
						<div class="col-md-6 control-img">
							<img src="img/die-coackroach.jpg" alt="" />
						</div>
						<div class="col-md-6 control-text">
						
							<h3>Prevention:</h3>
    <p><i class="fa fa-angle-right"></i>Keep cooking, eating and food storage areas clean and dry.</p>
    <p><i class="fa fa-angle-right"></i>If you see cockroaches, it is best to call a pest management professional due to the illnesses they can spread.</p>
